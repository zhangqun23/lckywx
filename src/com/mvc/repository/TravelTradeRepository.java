...
public interface TravelTradeRepository extends JpaRepository<TravelTrade, Integer>{
	...
	public void updateRefundTrade(@Param("refund_id") String refund_id, @Param("refund_fee") String refund_fee,
	...
	public void updateRefundTrade(@Param("refund_fee") String refund_fee,
			@Param("refund_time") String data, @Param("trtr_id") Integer trtr_id);
}
